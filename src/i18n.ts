...
export const translations = {
  en: {
    ...
    settings: {
      title: "Settings",
      description: "Provider, contexts, proxy, shortcuts, appearance, startup, and language.",
    ...
    general: {
      title: "General",
      description: "Appearance, language, startup, history, and timeout behavior.",
      theme: "Theme",
    ...
    provider: {
      title: "Provider",
      description: "Whitelisted CLI settings for Codex, Claude, and Cursor.",
      activeProvider: "Active provider",
      codexExecutable: "Codex executable",
      claudeExecutable: "Claude executable",
      cursorExecutable: "Cursor executable",
      model: "Model",
  ...
  zh: {
    ...
    settings: {
      title: "设置",
      description: "配置模型服务、场景、代理、快捷键、外观、开机启动和语言。",
      sectionsLabel: "设置分区",
      closeLabel: "关闭设置",
      cancel: "取消",
      save: "保存",
    ...
    general: {
      title: "通用",
      description: "外观、语言、开机启动、历史记录和超时行为。",
      theme: "主题",
      themeDescription: "跟随系统外观，或选择固定主题。",
      themeSystem: "跟随系统",
      themeLight: "浅色",
      themeDark: "深色",
      launchAtLogin: "开机自启动",
    ...
    provider: {
      title: "模型服务",
      description: "Codex、Claude 和 Cursor 的白名单 CLI 参数。",
      activeProvider: "当前服务",
      codexExecutable: "Codex 可执行文件",
      claudeExecutable: "Claude 可执行文件",
      cursorExecutable: "Cursor 可执行文件",
      model: "模型",
      defaultValue: "默认",
      customModel: "自定义",
